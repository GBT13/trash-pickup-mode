...
--         if playerInventories[event.player_index][item] ~= nil then
--             diff = amount - playerInventories[event.player_index][item]
--         else
--             diff = amount
--         end
...
--     playerInventories[event.player_index] = inventoryContent
-- end)
...
script.on_event(defines.events.on_lua_shortcut, function(event)
    ...
    player.set_shortcut_toggled("trash-pickup-toggle", not player.is_shortcut_toggled("trash-pickup-toggle"))


    game.print("Yaaay button toggled to")
    game.print(player.is_shortcut_toggled("trash-pickup-toggle"))
end)
